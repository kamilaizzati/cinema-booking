...
export default function AdminLoginPage() {
    ...
    return (<div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-dark-950 via-dark-900 to-primary-950">
    ...
    })} type="text" className="input" placeholder="Enter admin username"/>
    ...
    })} type={showPassword ? 'text' : 'password'} className="input pr-10" placeholder="Enter admin password"/>
